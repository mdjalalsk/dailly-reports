...
//                do_settings_sections( 'pvc_settings_group' );
//                ?>
<!--                <table class="form-table">-->
<!--                    <tr valign="top">-->
<!--                        <th scope="row">Reset Daily Views</th>-->
<!--                        <td><input type="checkbox" name="pvc_reset_daily" value="1" --><?php //checked( 1, get_option( 'pvc_reset_daily' ), true ); ?><!-- /></td>-->
<!--                    </tr>-->
<!--                    <tr valign="top">-->
<!--                        <th scope="row">Reset Monthly Views</th>-->
<!--                        <td><input type="checkbox" name="pvc_reset_monthly" value="1" --><?php //checked( 1, get_option( 'pvc_reset_monthly' ), true ); ?><!-- /></td>-->
<!--                    </tr>-->
<!--                </table>-->
<!--                --><?php //submit_button(); ?>
<!--            </form>-->
